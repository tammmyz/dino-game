...
class TestInstructions(unittest.TestCase):
    ...
    def test_c_audio_press(self):
        print("this is the the audio press test")
        global_var.test_settings = True
        menu(1)
        self.assertEqual(global_var.audio, True)
        global_var.test_settings = False
        global_var.audio = True


    def test_d_default_press(self):
    ...
    def test_e_default_theme(self):
        print("this is the default_theme")
        self.assertEqual(global_var.theme, 'default')

    def test_f_student_theme(self):
