...
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] \textcolor{blue}{Leaders Module}
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] \textcolor{blue}{Display Module }
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] \textcolor{blue}{Username Module} 

\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] \sout{Instructions display Module}
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] \sout{Leaderboard display Module}
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] \sout{Game Settings Display}
